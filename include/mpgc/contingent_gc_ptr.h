...
namespace mpgc {
  ...
  class controlled_gc_ptr {
   ...
   public:
    ...
    controlled_gc_ptr(const controlled_gc_ptr&) noexcept = default;
    controlled_gc_ptr(controlled_gc_ptr&&) noexcept = default;

    controlled_gc_ptr &operator =(const controlled_gc_ptr&) noexcept = default;
    controlled_gc_ptr &operator =(controlled_gc_ptr&&) noexcept = default;
